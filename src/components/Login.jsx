      ...
      <div className="container mx-auto max-w-7xl grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <motion.button 
              whileHover={{ scale: 1.02, y: -1, boxShadow: "0 15px 30px rgba(99,102,241,0.35)" }}
              whileTap={{ scale: 0.99 }}
              type="submit"
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              type="button" 
              className="flex items-center justify-center gap-3 bg-white/[0.03] border border-white/5 py-3 rounded-2xl text-sm font-semibold text-white transition-all duration-300"
            >
              <Icons.Google /> Google
            </motion.button>
            <motion.button 
